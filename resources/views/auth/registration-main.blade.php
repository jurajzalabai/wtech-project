...
<main class="container justify-content-center pt-5">
    <section class="sign-in">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <input id="name" name="name" type="text" required autofocus class="form-control rounded-pill form-width"><br>

            <label for="phone_number">Telefónne číslo:</label><br>
            <input id="phone_number" name="phone_number" required type="tel" class="form-control rounded-pill form-width"><br>

            <label for="email">Email:</label><br>
            <input id="email" name="email" type="email" required class="form-control rounded-pill form-width"><br>

            <label for="city">Mesto:</label><br>
            <input id="city" name="city" required type="text" class="form-control rounded-pill form-width"><br>

            <label for="postal_code">PSČ:</label><br>
            <input id="postal_code" required name="postal_code" type="text" class="form-control rounded-pill form-width"><br>

            <label for="street">Ulica:</label><br>
            <input id="street" name="street" required type="text" class="form-control rounded-pill form-width"><br>
